...
- Create Angular project with ng: `ng new photographystore.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`photographystore.client.esproj`).
